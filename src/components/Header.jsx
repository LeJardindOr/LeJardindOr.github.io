  ...
  return (
    <header className="bg-gradient px-5 py-3">
      <nav className="flex items-center justify-between flex-wrap p-6">
        ...
        <div className="w-full flex-grow flex items-center" id="navbarNavMobile" style={hamburgerMenuAnimation}>
        ...
        <div className="hidden lg:block flex items-center w-auto" id="navbarNavDesktop">
